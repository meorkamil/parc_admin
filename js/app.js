...
function renderCars(doc) {
    ...
    release.style.marginRight = "10px";
    ...
    li.appendChild(gap);
    //li.append(td);
    //console.log(li.rowIndex);
    //addButtonToTable(release, carslist);
    //li.appendChild(td);
    //li.append(td);

    gap.appendChild(release);
...
function renderTotalTransactions(doc) {
    ...
    transTotal.innerHTML += 'RM ' + total_sum + '<br>';
    transSum.innerHTML += total;
}

function renderTotalCars(doc) {
    carsTotal.innerHTML += doc;
}
